	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.xyz = float3(0.745283, 0.745283, 0.745283) - tmp2.xyz;
                tmp2.xyz = tmp3.xyz * float3(0.64, 0.64, 0.64) + tmp2.xyz;
                ...
                tmp1.w = rsqrt(tmp1.w);
                tmp3.xyz = tmp1.www * inp.texcoord.xyz;
                tmp5.xyz = tmp2.xyz - float3(0.2209163, 0.2209163, 0.2209163);
                tmp5.xyz = tmp5.xyz * float3(1.01, 1.01, 1.01) + float3(0.2209163, 0.2209163, 0.2209163);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4.xyz = float3(0.745283, 0.745283, 0.745283) - tmp3.xyz;
                tmp3.xyz = tmp4.xyz * float3(0.64, 0.64, 0.64) + tmp3.xyz;
                ...
                tmp6.xyz = tmp6.xyz * float3(1.01, 1.01, 1.01) + float3(0.2209163, 0.2209163, 0.2209163);
                ...
                tmp2.x = saturate(dot(tmp5.xyz, tmp0.xyz));
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                tmp0.w = rsqrt(tmp0.w);
                o.texcoord.xyz = tmp0.www * tmp1.xyz;
                o.texcoord1.xyz = tmp0.xyz;
                o.texcoord2.xyz = _WorldSpaceCameraPos - tmp0.xyz;
                o.texcoord3 = float4(0.0, 0.0, 0.0, 0.0);
                return o;
			}
			// Keywords: 
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = inp.texcoord.yyy * unity_WorldToObject._m01_m11_m21;
                tmp1.xyz = unity_WorldToObject._m00_m10_m20 * inp.texcoord.xxx + tmp1.xyz;
                tmp1.xyz = unity_WorldToObject._m02_m12_m22 * inp.texcoord.zzz + tmp1.xyz;
                tmp0.x = dot(tmp0.xyz, tmp1.xyz);
                tmp1 = tmp0.xxxx - float4(0.1294118, 0.3088273, 0.402945, 0.4676432);
                tmp0.xyz = tmp0.xxx - float3(0.5499962, 0.6911727, 0.8147097);
                tmp0.xyz = saturate(tmp0.xyz * float3(7.082829, 8.094086, 5.483801));
                tmp1 = saturate(tmp1 * float4(5.573344, 10.62387, 15.45399, 12.14137));
                tmp2.xyz = tmp1.xxx * float3(0.4433962, -0.5566038, 0.3117281) + float3(0.5566038, 0.5566038, 0.5566038);
                tmp3.xyz = float3(0.0980392, 0.9853407, 1.0) - tmp2.xyz;
                tmp2.xyz = tmp1.yyy * tmp3.xyz + tmp2.xyz;
                tmp3.xyz = float3(1.0, 1.0, 0.39) - tmp2.xyz;
                tmp1.xyz = tmp1.zzz * tmp3.xyz + tmp2.xyz;
                tmp2.xyz = float3(1.0, 0.0, 0.3315091) - tmp1.xyz;
                tmp1.xyz = tmp1.www * tmp2.xyz + tmp1.xyz;
                tmp2.xyz = float3(0.0, 0.9201925, 1.0) - tmp1.xyz;
                tmp1.xyz = tmp0.xxx * tmp2.xyz + tmp1.xyz;
                tmp2.xyz = float3(1.0, 0.0, 0.8812718) - tmp1.xyz;
                tmp0.xyw = tmp0.yyy * tmp2.xyz + tmp1.xyz;
                tmp1.xyz = float3(0.6698113, 0.6698113, 0.6698113) - tmp0.xyw;
                tmp0.xyz = tmp0.zzz * tmp1.xyz + tmp0.xyw;
                tmp1.xyz = float3(0.745283, 0.745283, 0.745283) - tmp0.xyz;
                tmp0.xyz = tmp1.xyz * float3(0.64, 0.64, 0.64) + tmp0.xyz;
                o.sv_target.xyz = tmp0.xyz * float3(-0.0077908, -0.0077908, -0.0077908);
                tmp0.xyz = tmp0.xyz - float3(0.2209163, 0.2209163, 0.2209163);
                o.sv_target1.xyz = tmp0.xyz * float3(1.01, 1.01, 1.01) + float3(0.2209163, 0.2209163, 0.2209163);
                o.sv_target.w = 1.0;
                o.sv_target1.w = 0.64;
