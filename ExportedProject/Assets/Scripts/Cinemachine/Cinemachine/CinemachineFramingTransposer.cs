	...
	public class CinemachineFramingTransposer : CinemachineComponentBase
	{
		...
		public override void MutateCameraState(ref CameraState curState, float deltaTime)
		{
			...
			if (!orthographic && flag2)
			{
				...
				{
					num = a / (2f * Mathf.Tan(fieldOfView * ((float)Math.PI / 180f) / 2f));
			...
			float orthoSize = (lens.Orthographic ? lens.OrthographicSize : (Mathf.Tan(0.5f * fieldOfView * ((float)Math.PI / 180f)) * (num4 - vector6.z)));
