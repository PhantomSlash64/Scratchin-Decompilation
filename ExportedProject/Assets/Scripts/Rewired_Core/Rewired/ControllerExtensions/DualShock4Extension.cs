...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class kjrRtpVMhJPJSkHkAcpAyLvHEKf : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 HXdrpIalcqAYpAuAIDhnqyeoHAg;

			public readonly bool YxSCQUilOVOVIAbfGmstlMmXgrqk;

			public readonly int DgKZIwUKWYpoRBbYIharycQNYrN;

			public kjrRtpVMhJPJSkHkAcpAyLvHEKf(IDriver_DualShock4 driver, bool supportsVibration, int vibrationMotorCount)
			{
		...
		private kjrRtpVMhJPJSkHkAcpAyLvHEKf ptgshdhzmBqmpwQkacMBSGAyXPI;
		...
		internal DualShock4Extension(IDriver_DualShock4 driver)
			: base(new kjrRtpVMhJPJSkHkAcpAyLvHEKf(driver, driver.VibrationMotorCount > 0, driver.VibrationMotorCount))
		{
		...
		public void SetLightFlash(float onDuration, float offDuration)
		{
			...
			{
				ptgshdhzmBqmpwQkacMBSGAyXPI.HXdrpIalcqAYpAuAIDhnqyeoHAg.LightFlashOnDuration = onDuration;
				ptgshdhzmBqmpwQkacMBSGAyXPI.HXdrpIalcqAYpAuAIDhnqyeoHAg.LightFlashOffDuration = offDuration;
			}
		}
		...
		public void StopLightFlash()
		{
			...
			{
				ptgshdhzmBqmpwQkacMBSGAyXPI.HXdrpIalcqAYpAuAIDhnqyeoHAg.StopLightFlash();
			}
		}
		...
		{
			ptgshdhzmBqmpwQkacMBSGAyXPI = P_0 as kjrRtpVMhJPJSkHkAcpAyLvHEKf;
