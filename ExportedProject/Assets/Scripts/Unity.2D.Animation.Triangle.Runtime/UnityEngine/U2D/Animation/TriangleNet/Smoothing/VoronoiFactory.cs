...
namespace UnityEngine.U2D.Animation.TriangleNet.Smoothing
{
	internal class VoronoiFactory : IVoronoiFactory
	{
		...
		private ObjectPool<UnityEngine.U2D.Animation.TriangleNet.Topology.DCEL.Vertex> vertices;
		...
		{
			vertices = new ObjectPool<UnityEngine.U2D.Animation.TriangleNet.Topology.DCEL.Vertex>();
		...
		public void Initialize(int vertexCount, int edgeCount, int faceCount)
		{
			...
			{
				vertices.Put(new UnityEngine.U2D.Animation.TriangleNet.Topology.DCEL.Vertex(0.0, 0.0));
			}
		...
		public UnityEngine.U2D.Animation.TriangleNet.Topology.DCEL.Vertex CreateVertex(double x, double y)
		{
			...
			obj = new UnityEngine.U2D.Animation.TriangleNet.Topology.DCEL.Vertex(x, y);
			vertices.Put(obj);
			return obj;
		}
