...
namespace Cinemachine
{
	...
	[SaveDuringPlay]
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.cinemachine@2.7/manual/CinemachineBrainProperties.html")]
	public class CinemachineBrain : MonoBehaviour
	{
		...
		private void ProcessActiveCamera(float deltaTime)
		{
			...
			if (activeVirtualCamera == null)
			{
				...
				@default.Lens = LensSettings.FromCamera(m_OutputCamera);
				@default.BlendHint |= (CameraState.BlendHintValue)67;
				CameraState state = ((SoloCamera != null) ? SoloCamera.State : @default);
				PushStateToUnityCamera(in state);
			}
			else
			{
				...
				CameraState state = ((SoloCamera != null) ? SoloCamera.State : mCurrentLiveCameras.State);
				PushStateToUnityCamera(in state);
			}
