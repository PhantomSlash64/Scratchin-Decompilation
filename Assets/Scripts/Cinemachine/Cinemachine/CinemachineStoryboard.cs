...
namespace Cinemachine
{
	...
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.cinemachine@2.7/manual/CinemachineStoryboard.html")]
				...
				if (canvasInfo == null)
				{
					...
					while (canvasInfo.mCanvas == null && num2 < childCount)
					{
						...
						if (rectTransform != null && rectTransform.name == CanvasName)
						{
							...
							canvasInfo.mViewport = canvasInfo.mCanvas.GetComponentsInChildren<RectTransform>()[1];
