...
public class PlayerIcoRiv2 : MonoBehaviour
{
	public bool DebugMode;

	public static bool ReadyToLoadSong;
	...
	public Animator PlayerL6;

	public Animator PlayerL7;
	...
	private IEnumerator SongDelay()
	{
		yield return new WaitForSeconds(6f);
		_ = MentorIcoRiv2.Difficulty2 == "Normal";
		ReadyToLoadSong = true;
	}

	private void songDelay()
	{
	...
	private void ACPsliderAdj()
	{
		...
		Debug.Log("ACPSlider.maxValue: " + SumScoreManager.NoteAmount);
	}
	...
	private void On_LineStart(KoreographyEvent evt)
	{
		...
		if (!FreeStyle)
		{
			...
			NextLineWhole.SetTrigger("ComeBack");
			...
			{
				voice.volume = 0.7f;
				if (MentorIcoRiv2.Difficulty2 == "Easy")
				{
					ACPSlider.maxValue = 3f;
					FunkSlider.maxValue = 48f;
					funkneeded = 12;
					grooveneeded = 48;
				}
			}
	...
	{
		if (freeLoop_obj.activeInHierarchy && GrooveReady && GrooveModeEnabled)
		{
			GrooveReady = false;
			active2 = true;
		}
	...
	private void Update()
	{
		...
		if (active && !active2)
		{
			...
			if (RhyLine_P.Blocks > 2)
			{
				PressesAllowed = (float)Dots * 0.4f;
			}
			else
			{
				PressesAllowed = Dots + 4;
			}
		}
		if (active2)
		{
		...
		if (!gamePaused)
		{
			...
			if (player.GetButtonDown("Butt1") && active && !ButtBusy && line == 7f)
			{
				...
				if (Butt1Presses == 0f)
				{
					if (MentorIcoRiv2.Difficulty2 == "Normal")
					{
						voice.clip = p12;
						PlayerL5.SetTrigger("A");
					}
					else if (MentorIcoRiv2.Difficulty2 == "Easy")
					{
						voice.clip = p13;
						PlayerL5.SetTrigger("A2");
					}
				}
				else
				{
			...
			{
				anim.SetTrigger("speak");
				if (Butt1Presses % 2f == 0f)
				{
					voice.clip = p14;
					PlayerL6.SetTrigger("A");
				}
				else
				{
					voice.clip = p17;
					PlayerL6.SetTrigger("A2");
				}
				voice.Play();
				Butt1Presses += 1f;
				ButtBusy = true;
			...
			if (player.GetButtonDown("Butt2") && active && !ButtBusy && line == 8f)
			{
				if (MentorIcoRiv2.Difficulty2 == "Normal")
				{
					...
					{
						voice.clip = p15;
						PlayerL6.SetTrigger("B");
					}
					else
					{
						voice.clip = p16;
						PlayerL6.SetTrigger("B2");
					}
					voice.Play();
					Butt2Presses += 1f;
					ButtBusy = true;
			...
			if (player.GetButtonDown("Butt3") && active && !ButtBusy && line == 8f)
			{
				...
				{
					voice.clip = p18;
					PlayerL6.SetTrigger("Y");
				}
				else
				{
					voice.clip = p21;
					PlayerL6.SetTrigger("Y2");
				}
				voice.Play();
				Butt3Presses += 1f;
				ButtBusy = true;
			...
			if (player.GetButtonDown("Butt4") && active && !ButtBusy && line == 8f)
			{
				...
				{
					voice.clip = p19;
					PlayerL6.SetTrigger("X");
				}
				else
				{
					voice.clip = p20;
					PlayerL6.SetTrigger("X2");
				}
				voice.Play();
				Butt4Presses += 1f;
				ButtBusy = true;
			...
			if (player.GetButtonDown("Butt1") && active && !ButtBusy && line == 9f)
			{
				if (MentorIcoRiv2.Difficulty2 == "Normal")
				{
					...
					{
						voice.clip = p23;
						PlayerL7.SetTrigger("A");
					}
					else
					{
						voice.clip = p24;
						PlayerL7.SetTrigger("A2");
					}
					voice.Play();
					Butt1Presses += 1f;
					ButtBusy = true;
			...
			if (player.GetButtonDown("Butt4") && active && !ButtBusy && line == 9f)
			{
				...
				{
					voice.clip = p22;
					PlayerL7.SetTrigger("X");
				}
				else
				{
					voice.clip = p22;
					PlayerL7.SetTrigger("X2");
				}
				voice.Play();
				Butt4Presses += 1f;
				ButtBusy = true;
			...
			if (player.GetButtonDown("Butt1") && active && !ButtBusy && line == 12f && LineReady)
			{
				anim.SetTrigger("speak");
				voice.clip = miss;
				funk -= 20;
			...
			if (player.GetButtonDown("Butt2") && active && !ButtBusy && line == 12f && LineReady)
			{
				anim.SetTrigger("speak");
				voice.clip = p43;
				voice.Play();
			...
			if (player.GetButtonDown("Butt3") && active && !ButtBusy && line == 12f && LineReady)
			{
				anim.SetTrigger("speak");
				if (Butt3Presses == 0f)
				{
					voice.clip = p40;
					PlayerL8.SetTrigger("Y");
				}
				else
				{
					voice.clip = p41;
			...
			if (player.GetButtonDown("Butt4") && active && !ButtBusy && line == 12f && LineReady)
			{
				anim.SetTrigger("speak");
				voice.clip = p42;
				voice.Play();
			...
			if (player.GetButtonDown("ZL") && active && line == 12f && LineReady)
			{
				anim.SetTrigger("speak");
				voice.clip = miss;
				funk -= 20;
			...
			if (player.GetButtonDown("ZR") && active && line == 12f && LineReady)
			{
				anim.SetTrigger("speak");
				voice.clip = miss;
				funk -= 20;
			...
			if (player.GetButtonDown("Up") && active && !ButtBusy && line == 12f && LineReady)
			{
				voice.clip = miss;
				voice.Play();
				UpPresses += 1f;
			...
			if (player.GetButtonDown("Down") && active && !ButtBusy && line == 12f && LineReady)
			{
				voice.clip = miss;
				funk -= 20;
				ACP--;
			...
			if (player.GetButtonDown("Left") && active && !ButtBusy && line == 12f && LineReady)
			{
				voice.clip = miss;
				funk -= 20;
				ACP--;
			...
			if (player.GetButtonDown("Right") && active && !ButtBusy && line == 12f && LineReady)
			{
				voice.clip = miss;
				funk -= 20;
				ACP--;
	...
	private void On_Up(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Up") && !ACPalready)
			{
				ACPalready = true;
				funk += 3;
				ACP++;
	...
	private void On_Down(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Down") && !ACPalready)
			{
				ACPalready = true;
				funk += 3;
				ACP++;
	...
	private void On_Left(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Left") && !ACPalready)
			{
				ACPalready = true;
				funk += 3;
				ACP++;
	...
	private void On_Right(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Right") && !ACPalready)
			{
				ACPalready = true;
				funk += 3;
				ACP++;
	...
	private void On_Abutt(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Butt1") && !ACPalready)
			{
				funk += 3;
				ACP++;
				ACPalready = true;
	...
	private void On_Bbutt(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Butt2") && !ACPalready)
			{
				funk += 3;
				ACP++;
				ACPalready = true;
	...
	private void On_Xbutt(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Butt4") && !ACPalready)
			{
				funk += 3;
				ACP++;
				ACPalready = true;
	...
	private void On_Ybutt(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("Butt3") && !ACPalready)
			{
				funk += 3;
				ACP++;
				ACPalready = true;
	...
	private void On_Lbutt(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("ZL") && !ACPalready)
			{
				funk += 3;
				ACP++;
				ACPalready = true;
	...
	private void On_Rbutt(KoreographyEvent evt)
	{
		...
		{
			ACPalready = false;
			if (player.GetButtonDown("ZR") && !ACPalready)
			{
				funk += 3;
				ACP++;
				ACPalready = true;
