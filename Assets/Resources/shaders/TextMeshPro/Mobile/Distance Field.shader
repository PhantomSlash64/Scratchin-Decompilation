	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                tmp1.xy = _ScreenParams.yy * glstate_matrix_projection._m01_m11;
                tmp1.xy = glstate_matrix_projection._m00_m10 * _ScreenParams.xx + tmp1.xy;
                ...
                tmp1.y = _Sharpness + 1.0;
                tmp1.x = tmp1.y * tmp1.x;
                tmp1.y = tmp0.w * tmp1.x;
                tmp1.z = 1.0 - _PerspectiveFilter;
                tmp1.z = tmp1.z * abs(tmp1.y);
                tmp0.w = tmp0.w * tmp1.x + -tmp1.z;
                tmp0.z = abs(tmp0.z) * tmp0.w + tmp1.z;
                tmp0.w = glstate_matrix_projection._m33 == 0.0;
                tmp0.z = tmp0.w ? tmp0.z : tmp1.y;
